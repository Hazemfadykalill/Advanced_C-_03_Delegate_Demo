...
namespace Advanced_C__03_Delegate
{
    public  class Sorting <T>
    {
        ...
        #region Delegate 
        public delegate bool SortingDelegateGraterOrSmallest(T L ,T R);   
        ...
        public static bool Greater(string left, string Right) => left.Length < Right.Length;
        public static bool Smallest(string left, string Right) => left.Length > Right.Length;
        #endregion
        #endregion
        ...
        public static void BubbleSortWithDelegateWithGenerics(T[] arr, SortingDelegateGraterOrSmallest del)
        {
            if (arr is not null)
            {
                for (int i = 0; i < arr.Length; i++)
